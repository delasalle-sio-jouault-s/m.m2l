				...
				if ( $dao->aPasseDesReservations($name) ){
					...
					if ( !$ok ){
						...
						if ( ! $ok ) {
							...
							$message = "Suppression effectué.<br>L'envoi du mail à l'utilisateur a rencontré un problème !";
							$typeMessage = 'avertissement';
							$themeFooter = $themeProbleme;
							include_once ('vues/VueSupprimerUtilisateur.php');
						}
							...
							// tout a fonctionné
							$message = "Suppression effectué.<br>Un mail va être envoyé à l'utilisateur !";
