<?php
	...
	// Rôle : visualiser la demande de suppression d'un nouvel utilisateur
			...
			<div data-role="content">
				...
				<form action="index.php?action=SupprimerUtilisateur" method="post" data-ajax="false">
					...
					<div data-role="fieldcontain">
						<input type="submit" name="btnSuppUtilisateur" id="btnSuppUtilisateur" value="Supprimer l'utilisateur" data-mini="true">
					</div>
				</form>
